...
class TVCCategoriaiPhone: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.categorias[(indexPath as NSIndexPath).row]
        return cell
    }
    /*
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let detailController = navController.topViewController as! TVCAppiPhone
        detailController.tipo = (ip! as NSIndexPath).row
